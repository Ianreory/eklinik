...
@section('isi')
    ...
    <div class="table-container1">
        <div class="justify-content-center align-items-center d-flex">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Form Update persalinan') }}</div>
                    <div class="formpasiena">
                        <form action="{{ route('update_persalinan', $persalinan) }}" method="post" autocomplete="off">
                            @csrf
                            @method('patch')
                            <div class="mb-3">
                                <label for="pasien_id" class="form-label">ID PASIEN</label>
                                <input type="text" name="pasien_id" id="pasien_id" class="form-control"
                                    value="{{ old('pasien_id', $persalinan->pasien_id) }}">
                                <div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" id="alamat" class="form-control">{{ old('alamat', $persalinan->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="sumber_pembiayaan" id="sumber_pembiayaan" class="form-control"
                                    value="{{ old('sumber_pembiayaan', $persalinan->sumber_pembiayaan) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="usia_ibu" id="usia_ibu" class="form-control"
                                    value="{{ old('usia_ibu', $persalinan->usia_ibu) }}">
                                @error('usia_ibu')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="status_imunisasi" id="status_imunisasi" class="form-control"
                                    value="{{ old('status_imunisasi', $persalinan->status_imunisasi) }}">
                            </div>
                            <div class="mb-3">
                                <label for="injeksi_td" class="form-label">Injeksi TD</label>
                                <input type="text" name="injeksi_td" id="injeksi_td" class="form-control"
                                    value="{{ old('injeksi_td', $persalinan->injeksi_td) }}">
                            </div>
                            <div class="mb-3">
                                <label for="skrining" class="form-label">Skrining</label>
                                <textarea name="skrining" id="skrining" class="form-control">{{ old('skrining', $persalinan->skrining) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="januari" class="form-label">Januari</label>
                                <textarea name="januari" id="januari" class="form-control">{{ old('januari', $persalinan->januari) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="februari" class="form-label">Februari</label>
                                <textarea name="februari" id="februari" class="form-control">{{ old('februari', $persalinan->februari) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="maret" class="form-label">Maret</label>
                                <textarea name="maret" id="maret" class="form-control">{{ old('maret', $persalinan->maret) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="april" class="form-label">April</label>
                                <textarea name="april" id="april" class="form-control">{{ old('april', $persalinan->april) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="mei" class="form-label">Mei</label>
                                <textarea name="mei" id="mei" class="form-control">{{ old('mei', $persalinan->mei) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="juni" class="form-label">Juni</label>
                                <textarea name="juni" id="juni" class="form-control">{{ old('juni', $persalinan->juni) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="juli" class="form-label">Juli</label>
                                <textarea name="juli" id="juli" class="form-control">{{ old('juli', $persalinan->juli) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="agustus" class="form-label">Agustus</label>
                                <textarea name="agustus" id="agustus" class="form-control">{{ old('agustus', $persalinan->agustus) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="september" class="form-label">September</label>
                                <textarea name="september" id="september" class="form-control">{{ old('september', $persalinan->september) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="oktober" class="form-label">Oktober</label>
                                <textarea name="oktober" id="oktober" class="form-control">{{ old('oktober', $persalinan->oktober) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="november" class="form-label">November</label>
                                <textarea name="november" id="november" class="form-control">{{ old('november', $persalinan->november) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="desember" class="form-label">Desember</label>
                                <textarea name="desember" id="desember" class="form-control">{{ old('desember', $persalinan->desember) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="tgl_lahir" class="form-label">Tanggal Lahir : </label>
                                <input type="date" name="tgl_lahir" id="tgl_lahir"
                                    value="{{ old('tgl_lahir', $persalinan->tgl_lahir) }}">
                            </div>
                            <div class="mb-3">
                                <label for="kurang_dari" class="form-label">&lt;2500 gr</label>
                                <input type="text" name="kurang_dari" id="kurang_dari" class="form-control"
                                    value="{{ old('kurang_dari', $persalinan->kurang_dari) }}">
                            </div>
                            <div class="mb-3">
                                <label for="lebih_dari" class="form-label">&lt;2500 gr</label>
                                <input type="text" name="lebih_dari" id="lebih_dari" class="form-control"
                                    value="{{ old('lebih_dari', $persalinan->lebih_dari) }}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="cara_persalinan" id="cara_persalinan" class="form-control"
                                    value="{{ old('cara_persalinan', $persalinan->cara_persalinan) }}">
                            </div>
