...
@section('isi')
    ...
    <div class="table-container1">
        <div class="justify-content-center align-items-center d-flex">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">{{ __('Form Update bpjs') }}</div>
                    <div class="formpasiena1">
                        ...
                        <form action="{{ route('update_bpjs', $bpjs) }}" method="post" autocomplete="off">
                            @csrf <!-- Laravel CSRF protection -->
                            @method('patch')
                            <br>
                            <div class="mb-3">
                                <label for="kunjungan_bpjs_id" class="form-label">ID PASIEN</label>
                                <input type="text" name="kunjungan_bpjs_id" id="kunjungan_bpjs_id" class="form-control"
                                    value="{{ old('kunjungan_bpjs_id', $bpjs->kunjungan_bpjs_id) }}">
                                <div>
                            ...
                            <div class="">
                                ...
                                <div class="formbpjs">
                                    ...
                                    <div>
                                        <input class="label" type="date" name="tgl_kunjungan" id="tgl_kunjungan"
                                            value="{{ old('tgl_kunjungan', $bpjs->tgl_kunjungan) }}">
                                    </div>
                                </div>
                                <div class="mb-6">
                                ...
                                <div>
                                    <textarea name="keluhan" id="keluhan" class="form-control">{{ old('keluhan', $bpjs->keluhan) }}</textarea>
                                </div>
                                <div class="mb-6">
                                ...
                                <div>
                                    <input type="text" name="anamnesa" id="anamnesa" class="form-control"
                                        value="{{ old('anamnesa', $bpjs->anamnesa) }}">
                                </div>
                                <div class="formbpjs">
                                    <div>
                                    ...
                                    <div class="label">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="makanan" class="form-control"
                                                value="{{ old('makanan', $bpjs->makanan) }}" aria-describedby="makanan">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" name="udara" class="form-control"
                                                value="{{ old('udara', $bpjs->udara) }}" aria-describedby="udara">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" name="obat" class="form-control"
                                                value="{{ old('obat', $bpjs->obat) }}" aria-describedby="obat">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-6">
                                ...
                                <div>
                                    <input type="text" name="prognosa" id="prognosa" class="form-control"
                                        value="{{ old('prognosa', $bpjs->prognosa) }}"></input>
                                </div>
                                <div class="mb-6">
                                ...
                                <div>
                                    <input type="text" name="terapi" id="terapi" class="form-control"
                                        value="{{ old('terapi', $bpjs->terapi) }}"></input>
                                </div>
                                <div class="mb-6">
                                ...
                                <div>
                                    <input type="text" name="terapi_non" id="terapi_non" class="form-control"
                                        value="{{ old('terapi_non', $bpjs->terapi_non) }}"></input>
                                </div>
                                <div class="mb-6">
                                    <label for="bmhp" class="form-label">BMHP</label>
                                </div>
                                <div>
                                    <textarea name="bmhp" id="bmhp" class="form-control">{{ old('bmhp', $bpjs->bmhp) }}</textarea>
                                </div>
                                <div class="mb-6">
                                    <label for="diagnosis" class="form-label">Diagnosis</label>
                                </div>
                                <div>
                                    <textarea name="diagnosis" id="diagnosis" class="form-control">{{ old('diagnosis', $bpjs->diagnosis) }}</textarea>
                                </div>
                                <div class="mb-6">
                                    <label for="kesadaran" class="form-label">Kesadaran</label>
                                </div>
                                <div>
                                    <textarea name="kesadaran" id="kesadaran" class="form-control">{{ old('kesadaran', $bpjs->kesadaran) }}</textarea>
                                </div>
                                <div class="formbpjs2">
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="tinggi_badan" id="tinggi_badan"
                                                    class="form-control"
                                                    value="{{ old('tinggi_badan', $bpjs->tinggi_badan) }}"
                                                    aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="berat_badan" id="berat_badan"
                                                    class="form-control"
                                                    value="{{ old('berat_badan', $bpjs->berat_badan) }}"
                                                    aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">cm</span>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="lingkar_perut" id="lingkar_perut"
                                                    class="form-control"
                                                    value="{{ old('lingkar_perut', $bpjs->lingkar_perut) }}"
                                                    aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">cm</span>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="imt" id="imt" class="form-control"
                                                    value="{{ old('imt', $bpjs->imt) }}" aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="sistole" id="sistole" class="form-control"
                                                    value="{{ old('sistole', $bpjs->sistole) }}"
                                                    aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">cm</span>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="diastole" id="diastole"
                                                    class="form-control" value="{{ old('diastole', $bpjs->diastole) }}"
                                                    aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">cm</span>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="respiratory_rate" id="respiratory_rate"
                                                    class="form-control"
                                                    value="{{ old('respiratory_rate', $bpjs->respiratory_rate) }}"
                                                    aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">cm</span>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="heart_rate" id="heart_rate"
                                                    class="form-control"
                                                    value="{{ old('heart_rate', $bpjs->heart_rate) }}"
                                                    aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">cm</span>
                                                </div>
                                ...
                                <div>
                                    <textarea name="tenaga_medis" id="tenaga_medis" class="form-control">{{ old('tenaga_medis', $bpjs->tenaga_medis) }}</textarea>
                                </div>
                                {{-- kk --}}
                                <div class="mb-6">
                                ...
                                <div>
                                    <textarea name="pelayanan" id="pelayanan" class="form-control">{{ old('pelayanan', $bpjs->pelayanan) }}</textarea>
                                </div>
                                <div class="mb-6">
                                    <label for="statuspulang" class="form-label">Status Pulang</label>
                                </div>
                                <div>
                                    <textarea name="statuspulang" id="statuspulang" class="form-control">{{ old('statuspulang', $bpjs->statuspulang) }}</textarea>
                                </div>
                                <div class="simpan1">
